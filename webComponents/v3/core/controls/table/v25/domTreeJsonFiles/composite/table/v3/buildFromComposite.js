 ...
 * where output of step i becomes input to step i+1
 */
export const applyStepsToSpecTree = ({ inSpecTree, inStepsDef, inTemplates }) => {
    const localSpecTree = inSpecTree;
    ...
    return stepsArray.reduce((currentSpecTree, stepDef) => {
        return applyStepToSpecTree({
