/**
 * Pure calculation functions for data model aggregations
 * Follows in -> local parameter naming convention
 */

export const extractNumber = ({ inValue }) => {
...
export const count = ({ inData, inKey }) => {
...
export const min = ({ inData, inKey, inType }) => {
    const localData = inData;
    const localKey = inKey;
...
export const max = ({ inData, inKey, inType }) => {
    const localData = inData;
    const localKey = inKey;
    const localType = inType;
